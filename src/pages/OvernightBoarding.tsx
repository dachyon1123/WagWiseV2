...
const sellingPoints = [
    {
        ...
        description:
            "Your dog will be cared for by trained staff around the clock, ensuring their safety and well-being. This constant supervision provides peace of mind, knowing that help is always available in case of an emergency."
    },
    {
    ...
    },
    {
        ...
        description:
            "Tailored services to match your dog’s dietary and medical requirements, including medication administration. Our attentive staff follows your specific care instructions to maintain your dog’s routine and health needs."
    },
    {
        title: "Peace of Mind",
        description:
